...
<ul>
  <li><strong>Palaco Pequeña, Ronal Edward:</strong> Desarrollador de software y Diseñador gráfico <a href="mailto:narotaipe@unsa.edu.pe">narotaipe@unsa.edu.pe</a></li>
  <li><strong>Cabrera Flores, Roy Huber:</strong> Desarrollador de software y Diseñador gráfico <a href="mailto:cgonzalesro@unsa.edu.pe">cgonzalesro@unsa.edu.pe</a></li>
  <li><strong>Charca Torres, Cynthia:</strong> Desarrollador de software y Diseñador gráfico <a href="mailto:jhumpire@unsa.edu.pe">jhumpire@unsa.edu.pe</a></li>
  <li><strong>Cabana Taco, Junior Evert:</strong> Desarrollador de software y Diseñador gráfico <a href="mailto:ridmecu@unsa.edu.pe">ridmecu@unsa.edu.pe</a></li>
...
<div class="row">
    ...
    <ul>
      <li><strong>Ing. Rendulich Talavera, Jorge Eusebio :</strong> Por su orientación, apoyo y valiosas sugerencias que contribuyeron significativamente al desarrollo y la calidad de este proyecto.</li>
    </ul>
