...
<div class="container my-5">
  ...
  <section id="credits" class="text-center mb-5">
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <h1 class="display-5 fw-bold mb-4">Créditos</h1>
        ...
        <div class="list-group shadow-lg rounded">
          <div class="list-group-item py-3 px-4">
            ...
            <a href="mailto:narotaipe@unsa.edu.pe" class="text-decoration-none text-primary">narotaipe@unsa.edu.pe</a>
          </div>
          <div class="list-group-item py-3 px-4">
            <strong>Gonzales Rodriguez, Ciolymar Johanna:</strong> Desarrollador de software y Diseñador gráfico 
            <a href="mailto:cgonzalesro@unsa.edu.pe" class="text-decoration-none text-primary">cgonzalesro@unsa.edu.pe</a>
          </div>
                    <div class="list-group-item py-3 px-4">
            <strong>Idme Cutipa, Ronaldiño Junior:</strong> Desarrollador de software y Diseñador gráfico 
            <a href="mailto:ridmecu@unsa.edu.pe" class="text-decoration-none text-primary">ridmecu@unsa.edu.pe</a>
          </div>
          <div class="list-group-item py-3 px-4">
            <strong>Mamani Ccopa, Bryan Omar:</strong> Desarrollador de software y Diseñador gráfico 
            <a href="mailto:bmamanicc@unsa.edu.pe" class="text-decoration-none text-primary">bmamanicc@unsa.edu.pe</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <hr class="my-5" style="border-top: 3px solid #2B3852; width: 60%;" />

  <!-- Agradecimientos Section -->
  <section id="acknowledgments" class="text-center mb-5">
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <h1 class="display-5 fw-bold mb-4">Agradecimientos</h1>
        ...
        <p>Un agradecimiento especial al profesor:</p>
